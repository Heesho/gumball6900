    ...
    <section id="sec-extras" className="section section--rule" aria-labelledby="sec-extras-h">
      <div className="container">
        <header className="sec-head reveal">
          ...
          <p className="lede">
            Five short facts before the argument: what signaling asks of you, why a listing can&#39;t be bought, and how
            little of this anyone can ever change.
          </p>
        </header>
        ...
        <div className="cols cols--2 extras-row">
          <div className="card card--pink reveal">
            ...
            <p className="card__body">
              ...
              transaction. There is no idle state to park in, and no lock-up to wait out: withdraw the moment you change
              your mind. While your signal stands, you earn a share of whatever your Strategy acquires, paid in that
              asset.
            </p>
          </div>
          <div className="card reveal" style={{ '--d': '90ms' } as React.CSSProperties}>
            ...
            <p className="note" style={{ marginTop: 'var(--s3)' }}>
              A description of where revenue mechanically goes and who directs it — not a claim about anyone&#39;s token
              price.
            </p>
          </div>
        </div>
        ...
        <div className="card extras-row reveal">
          <p className="card__head">
            The treasury always keeps at least <span className="num">80%</span>
          </p>
          <div className="split-grid">
            ...
            <div className="split__legend" aria-hidden="true">
              ...
              <p className="split__key">
                ...
                <span>
                  The adjustable band — the room between today&#39;s share and the cap; today it sits with the treasury.
                  The share can also fall, to zero.
                </span>
              </p>
              <p className="split__key">
          ...
          <div className="split">
            ...
            <div className="split__viz">
              ...
              <span className="split__todaylabel num" aria-hidden="true">
                signalers · 10% today
              </span>
        ...
        <div className="cols cols--2 extras-row">
          <div className="card card--ghost reveal">
            ...
            <p className="card__body">
              ...
              ask drops until a trader decides the lot is worth filling, and that fill is the price. The only price the
              protocol ever knows is the one a trader just paid.
            </p>
          </div>
