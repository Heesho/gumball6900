...
9. Reward and payment tokens admitted by the Resonance owner are externally implemented. Exact-delta checks fail
   closed for fee, surcharge, rebasing, shared-ledger, and callback anomalies; a broken token can still delay its own
   fixed claim.
