...
export const resonanceViewSchema = z.object({
  ...
  leftRevenue: unsignedBigIntSchema,
  minRevenueAmount: unsignedBigIntSchema,
...
export async function readResonanceView(
  ...
  const [
    ...
    read(client, blockNumber, resonance, resonanceAbi, 'leftRevenue'),
    read(client, blockNumber, resonance, resonanceAbi, 'MIN_REVENUE_AMOUNT'),
