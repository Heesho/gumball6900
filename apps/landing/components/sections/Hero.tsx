      ...
      <div className="container">
        <div className="hero">
          <div className="hero__brand reveal" style={{ '--d': '0ms' } as React.CSSProperties}>
            <Image className="hero__logo" alt="" src="/gumball-logo.png" width={208} height={208} priority />
            <h1 className="wordmark hero__wordmark" id="sec-hero-h">
              GumBall6900
            </h1>
          </div>
          <p className="lede hero__what reveal" style={{ '--d': '90ms' } as React.CSSProperties}>
            An index fund that lives onchain: it holds real tokenized assets, its holders steer what it buys, and any
            holder can burn their tokens to walk away with their share of everything inside.
          </p>
