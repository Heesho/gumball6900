...
9. Deploy LiquidityPosition with that exact pool, range, NFT ID, PositionManager, and ResonanceRouter. It is
...
11. Transfer Resonance ownership to the timelock and verify every immutable dependency, role, and one-time binding.
    Fund and LiquidityPosition are ownerless and require no ownership step.
