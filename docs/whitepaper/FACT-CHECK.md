...
| A reviewed external USDG-GBX LP token may be an ordinary Strategy asset | ADR 0050 and Strategy registration policy  | Deployment input; no address or liquidity guarantee is embedded |
