...
/// @title Acquisition strategy allocation-voter controls
/// @notice Budget-checkpoint surface consumed by AcquisitionStrategy.
interface IAcquisitionAllocationVoter {
