 ...
 * running head and folio. Everything else (palette, faces, measure) is the shared theme,
 * so the three editions read as one family.
 */

import { fonts, geometry, palette, radii, type } from '../whitepaper/src/theme.mjs';
...
p { margin: 0 0 3.4mm; text-align: justify; orphans: 2; widows: 2; }
